    ...
    <table><tr><td>
                <div class="menu">
                    <ul>
                        ...
                        <li><a href="ManageEmployees.jsp">Employees</a></li>
                        <li><a href="ManageUsers.jsp">Users</a></li>
                        <li><a href="#" >Manage</a>
                            <div>
                                <ul>
                                    <li><a href="ManageFAQ.jsp">FAQ</a></li>
                                    <li><a href="ManageSecurityQuestions.jsp">Security Question</a></li>
                        ...
                        <li><a href="#" >Reports</a>
                            <div>
                                <ul>
                                    ...
                                    <li><a href="EmployeesReport.jasper(Report)">Employees</a></li>
                                </ul>
                            </div>
                        </li>
                        <li><a href="#" >Account</a>
