                        ...
                        <fieldset>
                            ...
                            <table  align="center"  width="100%">
                                <tr>
                                    ...
                                    <td><input type="password" id="txtOldPassword" class="txtStyle" name="txtOldPassword" /></td>
                                </tr>
                                <tr>
                                    <td><b>New Password</b> </td>
                                    <td><input type="password"  id="txtNewPassword"  class="txtStyle" name="txtNewPassword"/></td>
                                </tr>
                                <tr>
                                    <td><b>Confirm Password</b></td>
                                    <td><input type="password"  id="txtConfirmPassword" class="txtStyle" name="txtConfirmPassword"/></td>
                                </tr>
                                <tr>
