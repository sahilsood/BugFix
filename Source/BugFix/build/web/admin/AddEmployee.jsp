...
<html>
    ...
    <body>
        ...
        <%UserServices objServices = new UserServices();
            ...
            lstUsers = objServices.getAllUsers();
        ...
        <form action="#">
            <table align="center" cellpadding="5" border="0" >
                <tr>
                    <td align="center">
                        <strong>Select from Users</strong><br/>
                    </td>
                </tr>
                <tr>
                    <td align="left">
                        ...
                        <table align="center"  border="1" width = 100%>
                            ...
                            <c:forEach items="${LIST_USERS}" var="obj" varStatus="i">
                                <tr>
                                    ...
                                    <td>
                                        <a href="EmpController.jsp?changeUserType=user&userId=${obj.userId}">Make Employee</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
                ...
                <tr>
                    <td colspan="6" align="center">
                        <input type="button" class="button" name="sbtnBack" onclick="window.location = 'ManageEmployees.jsp'" value="Back"/>
                    </td>
                </tr>
            </table>
        </form>
